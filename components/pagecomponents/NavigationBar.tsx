    ...
    if (show) {
        return (
            ...
            >
                ...
                <span>
                    We are in development and a lot of things said on this
                    website may not be there yet.
                </span>
            </Alert>
        );
    }
        ...
        <>
            ...
            <Nav className="navbar navbar-expand-lg sticky-top bg-nav shadow-lg">
                <span className="d-flex flex-grow-1 px-4">
                    ...
                    <button
                        className="btn-secondary navbar-toggler align-self-center"
                ...
                <div className="collapse navbar-collapse" id="navigationBar">
                    <ul className="navbar-nav gap-2 gap-lg-4 col-12 col-lg-auto px-3 px-lg-0 mt-2 mt-lg-0 mb-3 mb-lg-0">
                            ...
                            <Link href="/" passHref={true}>
                                <a
                                    className={
                                        router.pathname == '/'
                                            ? 'nav-active'
                                            : 'text-decoration-none nav-hover'
                                    }
                                >
                        ...
                        <li>
                            <a
                                className="nav-hover text-decoration-none"
                        ...
                        <li>
                            <a
                                className="nav-hover text-decoration-none"
                                href="https://forums.avalanchepowered.org/resources"
                            >
                                <div className="nav-link px-3 link-light monserrat">
                                    <span className="px-2">
                                        <FontAwesomeIcon
                        ...
                        <li>
                            <a
                                className="nav-hover text-decoration-none"
                                href="https://github.com/JSPrismarine/JSPrismarine/releases/latest"
                            >
                                <div className="nav-link px-3 link-light monserrat">
                                    <span className="px-2">
                                        <FontAwesomeIcon
                ...
                <div className="d-flex justify-content-end gap-3 nav-link">
                    <a
                        href="https://github.com/JSPrismarine"
                        target="_blank"
                        rel="noreferrer"
